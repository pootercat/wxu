...
// page title
define('TITLE', 'WingsXtremeU');

// Site Tagline
define('SITE_TAGLINE', 'Get Sauced!');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'indiana wings, wing delivery, bbq wings, bloomington wings, wings bloomingon IN, campus food, iu wings');
